...
Python Dependencies: pandas, numpy, matplotlib, seaborn, scipy, sklearn, statsmodels, * <a href="https://github.com/facebook/fbpca">Facebook PCA</a> (though sklearn SVD or PCA should also work), nextworkx , and <a href="http://www.mapequation.org/code.html">Infomap</a> (this can be removed , 
